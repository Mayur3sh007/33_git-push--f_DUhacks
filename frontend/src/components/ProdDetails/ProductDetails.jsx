  ...
  return (
    <div className="w-full text-white ">
      ...
      <div className='bg-gray-950 w-full px-14'>
        ...
        {user ? (
          <form onSubmit={handleSubmitReview} className="w-full mx-auto mt-16 pt-8  text-white shadow rounded">
            ...
            <div className="mb-4">
              <textarea id="message" placeholder='Write about your experience...' value={comment} onChange={handleReviewChange} className="w-full py-2 px-4 rounded-lg bg-gray-800 focus:outline-none focus:ring-2 text-xl focus:ring-blue-500"></textarea>
            </div>
